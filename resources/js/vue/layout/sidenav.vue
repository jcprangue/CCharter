<template>
    <div class="sidenav col-md-3 p-0 overflow-auto">
        <div class="w-100 bg-green-header header-height-15"></div>
        <div class="bg-greend-sub-header w-100 px-3 event-header">
            <div class="row align-items-center">
                <div class="col text-center"><icon icon="calendar-week"/> UPCOMING EVENTS</div>
            </div>
        </div>
       <div class="event center m-3">
            <div class="card mb-3" v-for="event in events">
                ...
                <div class="general">
                    ...
                    <span class="more"><icon icon="users"  /> {{ event.department }}</span>
                </div>
            </div>
        </div>
