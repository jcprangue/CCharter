<template>
     <div class="col-md-9" >
        <div class="container-fluid mt-3">
            ...
            <div v-if="!showtabular">
                <div class="row ">
                    <div class="col-md-3 d-flex align-items-stretch" v-for="department in dtData.data">
                        <blockquote class="department-blockquote w-100 text-center"><router-link :to="{name:'Charter', params:{id: department.id,code:null}}" class="text-green">{{ department.department }}</router-link></blockquote> 
                    </div>
                </div>
            </div>
        </div>
